-- Cashiers can export their own report. reports.view (20260730140000) gave them the scoped
-- "My sales" view, but the Export PDF button needs reports.export — so they could see their
-- numbers and not download them. Their PDF contains only what their screen shows.
